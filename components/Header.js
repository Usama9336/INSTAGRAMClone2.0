        ...
        <Image src={instagram}/>
          ...
          <div className='hidden w-[15.2rem]  sm:flex relative mx-2'>
            ...
            <div className='flex ml-[-4px] space-x-4 sm:flex sm:space-x-5'>
                ...
                <Image src={homeone} className="w-[1.6rem] h-[1.6rem] cursor-pointer hover:scale-[80%] duration-500"/>
                                 </div>
                 <div className='btn flex relative' onClick={()=>setopenchat(!openchat)}>
                 <Image src={send} className=" hover:scale-[80%] duration-500"/>
                 ...
                 <div className='btn mt-[3px] hidden sm:flex'>
                  <Image src={video} className=" hover:scale-[80%] duration-500"/>
                 </div>
                 <div className='btn mt-[3px] hidden sm:flex'>
                  <Image src={heart} className=" hover:scale-[80%] duration-500"/>
                 </div>
                 <div className='flex'>
                  <div className='btn mr-2 mt-[3px] ml-[-7px]' onClick={signIn}>
                  <img src={session ? session?.user?.image:CgProfile} alt="" className='rounded-full  hover:scale-[80%] duration-500'/>
                  </div>
